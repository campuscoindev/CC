...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CC:
            return QString("CC");
        case mCC:
            return QString("Milli-CC (1 / 1" THIN_SP_UTF8 "000)");
        case uCC:
            return QString("Micro-CC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CC:
            return QString("TestCCs");
        case mCC:
            return QString("Milli-TestCC (1 / 1" THIN_SP_UTF8 "000)");
        case uCC:
            return QString("Micro-TestCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
