...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CC features */
        {"cc", "masternode", &masternode, true, true, false},
        {"cc", "masternodelist", &masternodelist, true, true, false},
        {"cc", "mnbudget", &mnbudget, true, true, false},
        {"cc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cc", "mnsync", &mnsync, true, true, false},
        {"cc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ccd, or the -server option to cc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
