...
Below are some notes on how to build Campuscoin Core for Windows.
...
way. This will install to `c:\workspace\cc`, for example:

    make install DESTDIR=/mnt/c/workspace/cc
