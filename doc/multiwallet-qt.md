...
In order to support loading of multiple wallets in cc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cc.cpp.
...
Changes to cc.cpp
----------------------
cc.cpp is the entry point into cc-qt, and as such, will require some minor modifications to provide hooks for
