...
RESOURCES += src/qt/cc.qrc src/qt/cc_locale.qrc

TRANSLATIONS += src/qt/locale/cc_bg.ts \
                src/qt/locale/cc_de.ts \
                src/qt/locale/cc_en.ts \
                src/qt/locale/cc_es.ts \
                src/qt/locale/cc_fi.ts \
                src/qt/locale/cc_fr.ts \
                src/qt/locale/cc_it.ts \
                src/qt/locale/cc_ja.ts \
                src/qt/locale/cc_pl.ts \
                src/qt/locale/cc_pt.ts \
                src/qt/locale/cc_ru.ts \
                src/qt/locale/cc_sk.ts \
                src/qt/locale/cc_sv.ts \
                src/qt/locale/cc_vi.ts \
                src/qt/locale/cc_zh_CN.ts \
                src/qt/locale/cc_zh_TW.ts
