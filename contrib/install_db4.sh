...
# Copyright (c) 2023 The Campuscoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the Campuscoin repository."
  exit 1
fi
...
echo 'When compiling ccd, run `./configure` in the following way:'
echo
